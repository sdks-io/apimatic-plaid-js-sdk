...
import { Client, Configuration } from 'apimatic-plaid-sdk';
...
PLAID_CLIENT_ID_PLAID_CLIENT_ID=plaid-client-id
PLAID_SECRET_PLAID_SECRET=plaid-secret
PLAID_VERSION_PLAID_VERSION=plaid-version
