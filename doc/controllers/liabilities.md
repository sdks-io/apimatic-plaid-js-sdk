...
This method returns an [`ApiResponse`](../../doc/api-response.md) instance. The `result` property of this instance returns the response data which is of type [`LiabilitiesGetResponse`](../../doc/models/liabilities-get-response.md).

## Example Usage

```ts
const body: LiabilitiesGetRequest = {
