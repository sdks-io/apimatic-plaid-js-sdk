...
| `customTag` | `string \| null \| undefined` | Optional | An arbitrary string provided by the client for storage with the bank transfer. May be up to 100 characters.<br><br>**Constraints**: *Maximum Length*: `100` |
