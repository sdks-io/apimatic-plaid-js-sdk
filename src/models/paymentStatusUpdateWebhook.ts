...
import {
  NewPaymentStatus,
  newPaymentStatusSchema,
} from './newPaymentStatus.js';
import {
  OldPaymentStatus,
  oldPaymentStatusSchema,
} from './oldPaymentStatus.js';
    ...
    typedExpandoObject(
      {
        ...
        newPaymentStatus: ['new_payment_status', newPaymentStatusSchema],
        oldPaymentStatus: ['old_payment_status', oldPaymentStatusSchema],
