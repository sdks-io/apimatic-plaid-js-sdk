...
import {
  ...
  bankTransferDirection1EnumSchema,
} from './bankTransferDirection1Enum.js';
import {
...
import {
  ...
  bankTransferType1EnumSchema,
} from './bankTransferType1Enum.js';
...
export interface BankTransferEventListRequest {
  ...
  bankTransferType?: BankTransferType1Enum;
   ...
   */
  direction?: BankTransferDirection1Enum;
}

export const bankTransferEventListRequestSchema: Schema<BankTransferEventListRequest> = object(
  {
    ...
    bankTransferType: [
      'bank_transfer_type',
      optional(bankTransferType1EnumSchema),
    ],
    eventTypes: [
      'event_types',
      optional(array(bankTransferEventTypeEnumSchema)),
    ],
    ...
    direction: ['direction', optional(bankTransferDirection1EnumSchema)],
  }
);
