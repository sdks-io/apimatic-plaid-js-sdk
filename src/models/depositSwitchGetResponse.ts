...
import { StateEnum, stateEnumSchema } from './stateEnum.js';
import {
  SwitchMethodEnum,
  switchMethodEnumSchema,
} from './switchMethodEnum.js';
...
export const depositSwitchGetResponseSchema: Schema<DepositSwitchGetResponse> = object(
  {
    ...
    switchMethod: ['switch_method', optional(switchMethodEnumSchema)],
