...
import {
  VerificationStatus3,
  verificationStatus3Schema,
} from './verificationStatus3.js';
...
export const sandboxIncomeFireWebhookRequestSchema: Schema<SandboxIncomeFireWebhookRequest> = typedExpandoObject(
  {
    ...
    verificationStatus: ['verification_status', verificationStatus3Schema],
  },
