...
export const externalPaymentScheduleBaseSchema: Schema<ExternalPaymentScheduleBase> = typedExpandoObject(
  {
    interval: ['interval', optional(paymentScheduleIntervalSchema)],
