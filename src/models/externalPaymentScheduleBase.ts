...
export const externalPaymentScheduleBaseSchema: Schema<ExternalPaymentScheduleBase> = object(
  {
    interval: ['interval', optional(paymentScheduleIntervalEnumSchema)],
    intervalExecutionDay: ['interval_execution_day', optional(number())],
