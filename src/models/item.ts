...
import { UpdateType, updateTypeSchema } from './updateType.js';
  ...
  typedExpandoObject(
    {
      ...
      availableProducts: ['available_products', array(productsSchema)],
      billedProducts: ['billed_products', array(productsSchema)],
      consentExpirationTime: ['consent_expiration_time', nullable(string())],
      updateType: ['update_type', updateTypeSchema],
    },
