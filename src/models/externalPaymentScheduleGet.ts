...
export interface ExternalPaymentScheduleGet {
  ...
  interval: PaymentScheduleIntervalEnum;
  /**
...
export const externalPaymentScheduleGetSchema: Schema<ExternalPaymentScheduleGet> = object(
  {
    interval: ['interval', paymentScheduleIntervalEnumSchema],
