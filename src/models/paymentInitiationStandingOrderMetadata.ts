...
export interface PaymentInitiationStandingOrderMetadata {
  ...
  validStandingOrderIntervals: PaymentScheduleInterval[];
  additionalProperties?: Record<string, unknown>;
}

export const paymentInitiationStandingOrderMetadataSchema: Schema<PaymentInitiationStandingOrderMetadata> = typedExpandoObject(
  {
    ...
    validStandingOrderIntervals: [
      ...
      array(paymentScheduleIntervalSchema),
    ],
  },
