...
import { PaymentChannel, paymentChannelSchema } from './paymentChannel.js';
...
import { TransactionCode, transactionCodeSchema } from './transactionCode.js';
import {
  TransactionLocation,
  ...
  typedExpandoObject(
    {
      ...
      paymentChannel: ['payment_channel', paymentChannelSchema],
      ...
      transactionCode: ['transaction_code', transactionCodeSchema],
