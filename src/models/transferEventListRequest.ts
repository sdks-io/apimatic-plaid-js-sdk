...
import {
  TransferType2Enum,
  transferType2EnumSchema,
} from './transferType2Enum.js';
...
export interface TransferEventListRequest {
  ...
  transferType?: TransferType2Enum;
...
export const transferEventListRequestSchema: Schema<TransferEventListRequest> = object(
  {
    ...
    transferType: ['transfer_type', optional(transferType2EnumSchema)],
    eventTypes: ['event_types', optional(array(transferEventTypeEnumSchema))],
