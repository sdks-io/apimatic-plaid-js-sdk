...
export namespace Configuration {
  ...
  export function fromEnvironment(
    ...
    if (envVariables.PLAID_CLIENT_ID_PLAID_CLIENT_ID) {
      config.plaidClientIdCredentials = {
        'PLAID-CLIENT-ID': envVariables.PLAID_CLIENT_ID_PLAID_CLIENT_ID,
      };
    }

    if (envVariables.PLAID_SECRET_PLAID_SECRET) {
      config.plaidSecretCredentials = {
        'PLAID-SECRET': envVariables.PLAID_SECRET_PLAID_SECRET,
      };
    }

    if (envVariables.PLAID_VERSION_PLAID_VERSION) {
      config.plaidVersionCredentials = {
        'Plaid-Version': envVariables.PLAID_VERSION_PLAID_VERSION,
      };
    }
...
const configurationSchema: Schema<Partial<Configuration>> = object({
  ...
  plaidClientIdCredentials: [
    'plaidClientIdCredentials',
    optional(object({ 'PLAID-CLIENT-ID': ['PLAID-CLIENT-ID', string()] })),
  ],
  plaidSecretCredentials: [
    'plaidSecretCredentials',
    optional(object({ 'PLAID-SECRET': ['PLAID-SECRET', string()] })),
  ],
  plaidVersionCredentials: [
    'plaidVersionCredentials',
    optional(object({ 'Plaid-Version': ['Plaid-Version', string()] })),
  ],
  httpClientOptions: [
    'httpClientOptions',
    optional(
