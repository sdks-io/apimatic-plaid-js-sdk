...
export namespace Configuration {
  ...
  export function fromEnvironment(
    ...
    if (envVariables.PLAIDCLIENTID_PLAID_CLIENT_ID) {
      config.pLAIDCLIENTIDCredentials = {
        'PLAID-CLIENT-ID': envVariables.PLAIDCLIENTID_PLAID_CLIENT_ID,
      };
    }

    if (envVariables.PLAIDSECRET_PLAID_SECRET) {
      config.pLAIDSECRETCredentials = {
        'PLAID-SECRET': envVariables.PLAIDSECRET_PLAID_SECRET,
      };
    }
